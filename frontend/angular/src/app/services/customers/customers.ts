...
export class Customers {
  ...
  updateCustomer(id:number | undefined, customerUpdateRequest: CustomerUpdateRequest): Observable<void> {
    return this.http.put<void>(`${this.customerUrl}/${id}`,customerUpdateRequest)
  }
}
